...
public class ProductList_Etc extends JFrame implements MouseListener {
	public ProductList_Etc() {
		...
		//---------------------상품 1
		JButton button = new JButton("원목 하우스", new ImageIcon("img/doghouse.png"));
		...
		//---------------------상품 2
		JButton button1 = new JButton("강아지 화장실", new ImageIcon("img/toilet.png"));
		...
		button5.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				new Etc_Sham();
				System.out.println("[ -> 애견 샴푸]");
				setVisible(false); // 창 안보이게 하기
			}
		});

		//---------------------상품 7
		JButton button6 = new JButton("강아지 유모차", new ImageIcon("img/dog_cart.png"));
		...
		//---------------------상품 8
		JButton button7 = new JButton("강아지 욕조", new ImageIcon("img/bath_r.png"));
	...
	public void mousePressed(MouseEvent e) {
		...
		if (e.getModifiers() == MouseEvent.BUTTON3_MASK) {
			System.out.println("[기타 카테고리 -> 상품 홈]");
			new ProductMain();
			setVisible(false);
		}
	}
