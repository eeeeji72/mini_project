	...
	public ProductList_Clo() {
		...
		menuItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("[ 의류 카테고리 -> 베스트 카테고리]");
				setVisible(false); // 창 안보이게 하기
			}
		});		
		...
		public void actionPerformed(ActionEvent e) {
			new ProductList_Clo();
			System.out.println("[ 의류 카테고리 -> 의류 카테고리]");
			setVisible(false); // 창 안보이게 하기
			}
		});		
		...
		public void actionPerformed(ActionEvent e) {
			...
			System.out.println("[ 의류 카테고리 -> 장난감&간식 카테고리]");
			setVisible(false); // 창 안보이게 하기
			}
		});		
		...
		public void actionPerformed(ActionEvent e) {
			new ProductList_Acc();
			System.out.println("[ 의류 카테고리 -> 액세서리 카테고리]");
			setVisible(false); // 창 안보이게 하기
			}
		});						
		...
		public void actionPerformed(ActionEvent e) {
			new ProductList_Etc();
			System.out.println("[ 의류 카테고리 -> 기타 카테고리]");
			setVisible(false); // 창 안보이게 하기
			}
		});		
		...
		public void actionPerformed(ActionEvent e) {
			new Cart();
			System.out.println("[ 의류 카테고리 -> 장바구니]");
			setVisible(false); // 창 안보이게 하기
			}
		});		
		...
		public void actionPerformed(ActionEvent e) {
			//new ProductList_Acc();
			System.out.println("[ 의류 카테고리  -> 마이페이지]");
			//setVisible(false); // 창 안보이게 하기
			}
		});		
		...
		public void actionPerformed(ActionEvent e) {
			//new ProductList_Acc();
			System.out.println("[ 의류 카테고리  -> 고객센터]");
			//setVisible(false); // 창 안보이게 하기
			}
		});		
		...
		//---------------------상품 1
		JButton button = new JButton("니트 조끼", new ImageIcon("img/clo.png"));
		...
		//---------------------상품 2
		JButton button1 = new JButton("털실 모자(노랑)", new ImageIcon("img/cap_y.png"));
		...
		//---------------------상품 3
		JButton button2 = new JButton("카라 셔츠", new ImageIcon("img/sf.png"));
		...
		//---------------------상품 4
		JButton button3 = new JButton("털실 모자(분홍)", new ImageIcon("img/cap_pink.png"));
		...
		//---------------------상품 5
		JButton button4 = new JButton("털실 모자(파랑)", new ImageIcon("img/cap_blue.png"));
