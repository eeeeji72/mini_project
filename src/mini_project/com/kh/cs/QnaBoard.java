...
import miniproject_customerservice.com.kh.cs.InputForm_Qna;
import miniproject_customerservice.com.kh.cs.QnaBoard;
...
//	     System.out.println(table.getValueAt(srow, 2));
	 ...
	 */
		...
		/*
		 * public static void main(String[] args) { new QnaBoard();
		 * 
		 * }
		 * 
		 */
