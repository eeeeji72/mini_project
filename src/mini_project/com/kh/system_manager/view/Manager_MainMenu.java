...
import cs.board.MainBoard;
import mini_project.com.kh.main.MainPage11;
import mini_project.com.kh.product.ProductMain;
import mini_project.com.kh.system_manager.manager.ProductManagement;
import mini_project.com.kh.system_manager.manager.UserManagement;
...
public class Manager_MainMenu extends JFrame {
	...
	final String[] menuTitle = { "HOME", "CUSTOMER", "PRODUCT", "BOARD"};
...
class selectWindow extends JFrame implements ActionListener,WindowListener {
	...
	selectWindow() {
		...
		ImageIcon imgleft = new ImageIcon("img/userIcon");
		ImageIcon imgright = new ImageIcon("img/serviceIcon");
		
		bUService = new JButton("Service",new ImageIcon("img/userIcon"));
		bUManagement = new JButton("Manager",new ImageIcon("img/serviceIcon"));
		bUService.setSize(65,65);
		bUManagement.setSize(65,65);
		
		JLabel service = new JLabel(imgleft);
		JLabel manager = new JLabel(imgright);
		...
		left.add(service,BorderLayout.CENTER);
		left.add(bUService,BorderLayout.SOUTH);
		
		right.add(manager,BorderLayout.CENTER);
		right.add(bUManagement,BorderLayout.SOUTH);
